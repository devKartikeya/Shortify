...
const MyLinks = () => {
    ...
    const fetchLinks = async (isRefresh = false) => {
        try {
            ...
            if (!response.ok) {
                throw new Error(
                    result.message || "Failed to fetch your links"
                );
            }
            ...
            setError(
                err.message ||
                "Something went wrong while loading your links."
            );
    ...
    const filteredLinks = useMemo(() => {
        ...
        if (clickFilter === "10+") {
            result = result.filter(
                (link) => Number(link.clicks || 0) >= 10
            );
        }
        if (clickFilter === "50+") {
            result = result.filter(
                (link) => Number(link.clicks || 0) >= 50
            );
        }
        if (clickFilter === "100+") {
            result = result.filter(
                (link) => Number(link.clicks || 0) >= 100
            );
        }
        // -------------------------
        // DATE FILTER
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-1.5 max-w-2xl text-sm leading-6 text-gray-500">
                        Manage, track and organize every short link
                        you've created with Shortify.
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        <path
                            ...
                            d="M20 11a8.1 8.1 0 0 0-14.9-4.3L3 9"
                        />
                        ...
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M4 13a8.1 8.1 0 0 0 14.9 4.3L21 15"
                        />
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                ...
                <div className="flex flex-col gap-3 xl:flex-row">
                    ...
                    >
                        ...
                        <option value="most-clicked">
                            Most clicked
                        </option>

                        <option value="least-clicked">
                            Least clicked
                        </option>
                    </select>
