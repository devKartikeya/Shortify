    ...
    useEffect(() => {
        const checkAuth = async () => {
            try {
                ...
                console.error(
                    "Footer authentication check failed:",
                    error
                );
                    ...
                    <div className="grid gap-14 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
                        ...
                        <div className="max-w-sm">
                            ...
                            <p className="mt-6 text-sm leading-7 text-gray-400">
                                Make your links shorter, smarter, and easier
                                to manage. Shortify gives you a simple way to
                                create, organize, and track your shortened URLs.
                            </p>
                                    ...
                                    <li key={link.name}>
                                        ...
                                        {link.protected ? (
                                            <div
                                                ...
                                                className="text-sm text-gray-400 cursor-pointer transition-colors hover:text-yellow-400"
                                            >
                                                {link.name}
                                            </div>
                                        ) : (
